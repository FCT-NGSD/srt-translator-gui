...
def main(page: ft.Page):
    ...
    char_count_display = ft.Text("")

    save_srt_button = ft.ElevatedButton("翻訳結果を名前を付けて保存", icon=ft.Icons.SAVE, on_click=lambda e: save_translated_srt(e), disabled=True)
    translate_button = ft.ElevatedButton("翻訳実行", icon=ft.Icons.TRANSLATE, on_click=lambda e: translate_srt_clicked(e), disabled=True)
                ...
                try:
                    ...
                    try:
                        ...
                        if total_chars == 0 and current_srt_subs is not None:
                            ...
                            char_count_display.color = ft.Colors.GREEN
    ...
    def save_translated_srt(e):
        ...
        file_picker.on_result = on_save_srt_result
    ...
    def translate_srt_clicked(e):
        ...
        try:
            ...
            # ★★★ DeepL API呼び出しに split_sentences="off" を追加 ★★★
